...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'lincolnGold_firstBackup_767ee96598db78f92840_20200910232817_archive.zip';
	const ARCHIVE_SIZE		 = '1097937120';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '767ee96-10232817';
    const SECONDARY_PACKAGE_HASH = '9455fff-10232817';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.36==');
		self::log('----------------------------------------------------');
